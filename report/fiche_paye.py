...
class fiche_paye_altex(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(fiche_paye_altex, self).__init__(cr, uid, name, context)
...
class wrapped_report_fiche_paye(osv.AbstractModel):
    _name = 'report.hr_altex.altex_report_payslip'
    _inherit = 'report.abstract_report'
    _template = 'hr_altex.altex_report_payslip'
    _wrapped_report_class = fiche_paye_altex
